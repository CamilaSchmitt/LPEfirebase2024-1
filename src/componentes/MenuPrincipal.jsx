...
import { logout, auth, loginWithGithub } from '../firebaseConfig';
                                        ...
                                        <>
                                            ...
                                            >
                                                <MenuItem onClick={handleCloseNavMenuManutencoes}
                                                    component={NavLink} to="quadros">
                                                    <Typography textAlign="center">Quadros</Typography>
                                                </MenuItem>
                                            </Menu>
                                        </>
                                    }
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Menu do usuário">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}
                                    ...
                                    <Typography >{!user ? "Autenticar" : <> {user?.displayName}
                                    </>}</Typography>
